...
import com.example.TheLookSalon.model.DateInfo;
import com.example.TheLookSalon.utils.AuthUtils;
...
public class LashExtensionsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lashextentions);
        ...
        scheduleButton.setOnClickListener(view -> {
            ...
            DateInfo info = new DateInfo(dateCalendar.getTimeInMillis(), "Lash Extensions");
