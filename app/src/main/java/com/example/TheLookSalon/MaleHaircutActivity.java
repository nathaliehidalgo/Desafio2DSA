...
public class MaleHaircutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_malehaircut);
        ...
        scheduleButton.setOnClickListener(view -> {
            ...
            DateInfo info = new DateInfo(dateCalendar.getTimeInMillis(), "Male Haircut");
